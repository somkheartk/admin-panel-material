...
const translations: Record<Language, any> = {
  th: {
    ...
    dashboard: {
      ...
      recentUpdates: 'อัปเดตและกิจกรรมล่าสุด',
      recentUsers: 'ผู้ใช้ล่าสุด',
      recentOrders: 'คำสั่งซื้อล่าสุด',
      newUser: 'ผู้ใช้ใหม่สมัครสมาชิก',
      newOrder: 'มีคำสั่งซื้อใหม่',
      ...
      errorLoadStats: 'ไม่สามารถโหลดข้อมูลได้ กรุณาตรวจสอบการเชื่อมต่อกับ Backend',
    },
    users: {
      title: 'จัดการผู้ใช้',
  ...
  en: {
    ...
    dashboard: {
      ...
      recentUpdates: 'Recent updates and activities',
      ...
      noChange: 'No change',
      errorLoadStats: 'Failed to load data. Please check Backend connection',
    },
    users: {
